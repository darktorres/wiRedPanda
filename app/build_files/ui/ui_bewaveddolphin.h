...
public:
    ...
    void setupUi(QMainWindow *BewavedDolphin)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/toolbar/dolphin_icon.svg"), QSize(), QIcon::Normal, QIcon::Off);
        BewavedDolphin->setWindowIcon(icon);
        actionAbout = new QAction(BewavedDolphin);
        actionAbout->setObjectName("actionAbout");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/dolphin/help.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionAbout->setIcon(icon1);
        actionLoad = new QAction(BewavedDolphin);
        actionLoad->setObjectName("actionLoad");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/dolphin/folder.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionLoad->setIcon(icon2);
        actionExit = new QAction(BewavedDolphin);
        actionExit->setObjectName("actionExit");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/dolphin/exit.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionExit->setIcon(icon3);
        actionCombinational = new QAction(BewavedDolphin);
        actionCombinational->setObjectName("actionCombinational");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/toolbar/wavyIcon.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/dolphin/pdf.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionExportToPdf->setIcon(icon5);
        actionSave = new QAction(BewavedDolphin);
        actionSave->setObjectName("actionSave");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/dolphin/save.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/toolbar/copy.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionCopy->setIcon(icon7);
        actionPaste = new QAction(BewavedDolphin);
        actionPaste->setObjectName("actionPaste");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/dolphin/paste.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionPaste->setIcon(icon8);
        actionSetTo0 = new QAction(BewavedDolphin);
        actionSetTo0->setObjectName("actionSetTo0");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/input/0.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetTo0->setIcon(icon9);
        actionSetTo1 = new QAction(BewavedDolphin);
        actionSetTo1->setObjectName("actionSetTo1");
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/input/1.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/input/clock1.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetClockWave->setIcon(icon11);
        actionInvert = new QAction(BewavedDolphin);
        actionInvert->setObjectName("actionInvert");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/basic/not.svg"), QSize(), QIcon::Normal, QIcon::Off);
