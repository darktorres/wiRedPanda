...
Q_CONSTINIT static const qt_meta_stringdata_CLASSWorkSpaceENDCLASS_t qt_meta_stringdata_CLASSWorkSpaceENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 11),  // "fileChanged"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 9),  // "QFileInfo"
        QT_MOC_LITERAL(33, 8)   // "fileInfo"
    },
    "WorkSpace",
    "fileChanged",
    "",
...
void WorkSpace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WorkSpace::*)(const QFileInfo & );
            if (_t _q_method = &WorkSpace::fileChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
