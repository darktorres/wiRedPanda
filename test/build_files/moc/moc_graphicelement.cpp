...
struct qt_meta_stringdata_CLASSGraphicElementENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGraphicElementENDCLASS = QtMocHelpers::stringData(
    "GraphicElement",
    "pixmapPath",
    "titleText",
    "translatedName"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSGraphicElementENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphicElementENDCLASS_t qt_meta_stringdata_CLASSGraphicElementENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "GraphicElement"
        QT_MOC_LITERAL(15, 10),  // "pixmapPath"
        QT_MOC_LITERAL(26, 9),  // "titleText"
        QT_MOC_LITERAL(36, 14)   // "translatedName"
    },
    "GraphicElement",
    "pixmapPath",
    "titleText",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGraphicElementENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GraphicElement::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGraphicElementENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGraphicElementENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGraphicElementENDCLASS_t,
        // property 'pixmapPath'
        ...
        QtPrivate::TypeAndForceComplete<QString, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GraphicElement, std::true_type>
    >,
    nullptr
} };
...
void *GraphicElement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGraphicElementENDCLASS.stringdata0))
